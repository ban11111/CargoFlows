...
func registerExistingRoutes(protected *gin.RouterGroup, server *Server) {
	...
	inventoryManagers.POST("/inventory-transactions/:transaction_id/corrections/preview", server.previewInventoryCorrection)
	inventoryManagers.POST("/inventory-transactions/:transaction_id/corrections", server.createInventoryCorrection)
	inventoryManagers.GET("/inventory-transactions/:transaction_id/corrections", server.listInventoryCorrections)
...
func registerAIRoutes(protected *gin.RouterGroup, server *Server) {
	...
	aiSettings.PATCH("/settings/openai/timeouts", server.updateOpenAITimeouts)
