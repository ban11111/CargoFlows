...
func NewRouter(cfg config.Config, db *gorm.DB) *gin.Engine {
	...
	protected.GET("/sop-templates", server.listSOPTemplates)
	protected.POST("/sop-templates", server.createSOPTemplate)
	protected.PATCH("/sop-templates/:id", server.updateSOPTemplate)
