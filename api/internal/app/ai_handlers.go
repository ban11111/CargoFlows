...
func respondAIError(c *gin.Context, err error) {
	...
	case errors.Is(err, ai.ErrAssetNotEligible), errors.Is(err, ai.ErrStyleReferenceNotEligible), errors.Is(err, ai.ErrBrandIconNotEligible), errors.Is(err, ai.ErrExternalReferenceNotEligible), errors.Is(err, ai.ErrPublishedSOPNotFound):
