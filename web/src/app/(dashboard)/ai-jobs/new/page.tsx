...
export default function NewAIJobPage() {
  ...
  const selectedAssetViews = useMemo(() => new Set(approvedForSKU.filter((asset) => selectedAssets.includes(asset.id)).map((asset) => asset.sop_view_key)), [approvedForSKU, selectedAssets]);
