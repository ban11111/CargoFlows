...
describe("AIJobDetailPage", () => {
  ...
  it("edits, approves, previews, and explicitly applies a text candidate", async () => {
    ...
    vi.spyOn(globalThis, "fetch").mockImplementation(async (input, init) => {
      ...
      if (path.endsWith(`${resultPath}/apply`)) return new Response(JSON.stringify({ content: { public_id: "content-1", sku_id: job.sku_id, platform: "lazada", locale: "zh-CN", title: "CargoFlow 超薄透明手机壳", short_description: "", long_description: "", selling_points: [], search_keywords: [], revision: 1, updated_at: job.updated_at }, replayed: false }), { status: 200 });
